...
import COEModalContent from '../components/COEModalContent';
...
const HomePage = () => {
    ...
    return (
        <div style={backgroundStyle}>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                {mockCOEs.map(coe => (
                                    <button
                                        ...
                                        aria-label={`Open details for ${coe.name}`}
                                    >
            ...
            {/* Conditional Modal */}
            {selectedCoe && (
                <Modal isOpen={!!selectedCoe} onClose={() => setSelectedCoe(null)} title={selectedCoe.longName}>
                    <COEModalContent coe={selectedCoe} />
                </Modal>
            )}
