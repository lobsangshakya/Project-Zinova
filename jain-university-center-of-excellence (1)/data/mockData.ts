...
const facultyData: { [key: string]: { name: string; coes: string[]; description: string } } = {
    ...
    't-v-raman': { name: 'Dr. T V Raman', coes: ['emerging-tech'], description: "Dr. T.V. Raman’s current research primarily focuses on the Internet of Things (IoT) and Machine Learning. He has published extensively in reputed SCI-indexed journals, including IEEE Transactions and ACM Transactions. With several patents filed and granted across India, Australia, and Germany, Dr. Raman continues to make significant contributions to research, teaching, and innovation." },
...
const allUsers: User[] = [
    ...
    { id: 'faculty-swati-gupta', name: 'Dr. Swati Gupta', email: 'swati-gupta@jain.com', role: UserRole.FACULTY, avatarUrl: 'https://i.pravatar.cc/100?u=swati', coeId: 'ai-ml'},
...
export const mockCOEs: COE[] = [
    {
        ...
        facultyIds: ['faculty-swati-gupta', ...getFacultyIdsForCOE('ai-ml')],
    ...
    },
    {
        ...
        facultyIds: ['faculty-sunanda-das', ...getFacultyIdsForCOE('cyber-security')],
    ...
    },
    {
        ...
        facultyIds: ['faculty-vikram-neerugatti', ...getFacultyIdsForCOE('iot-robotics')],
    ...
    },
    {
        ...
        facultyIds: ['faculty-nishant-tripathi', ...getFacultyIdsForCOE('networking-hpc')],
